...
The software is distributed under the [OpenDocBot License](https://github.com/opendocbot/opendocbot/blob/main/LICENSE). By using, copying, modifying, or distributing the software, you agree to the terms of that license. These Terms of Use govern your use of the hosted add-in and website; the software license governs the source code.
...
* Reverse engineer, decompile, or extract the underlying software except as expressly permitted by the [OpenDocBot License](https://github.com/opendocbot/opendocbot/blob/main/LICENSE).
